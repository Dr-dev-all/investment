...
export default function About() {
  const content = (
    <main className="min-h-screen">
          ...
          <div className="opacity: 1; transform: none;">
            ...
            <div className="mt-10 max-w-2xl space-y-6 text-base">
              <p>
                ...
                interactions. Our commitment to ethical practices ensures that
                you can invest with confidence.
              </p>
              <p>
                The financial landscape is dynamic, and so are we. We are
                dedicated to continuous improvement, adapting to market trends,
                and enhancing our services to meet the evolving needs of our
                clients.
              </p>
            </div>
          </div>
          ...
          <div className="opacity: 1; transform: none;">
            ...
            <div className="mt-10 max-w-2xl space-y-6 text-base">
              <p>
                ...
                Together, we form a dynamic force committed to driving
      ...
      {/* <section className="mx-auto max-w-7xl px-2 lg:px-[1em] md:px-[5em] mt-24 sm:mt-32 lg:mt-40">
